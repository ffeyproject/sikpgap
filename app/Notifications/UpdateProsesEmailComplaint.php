...
class UpdateProsesEmailComplaint extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
         ...
         $url = url('keluhan/proses/'. $this->complaint->id);

        return (new MailMessage)
                ->from('it@gajahtex.com', 'IT GAP')
                ->subject('Success Proses Data Complaint' . $this->complaint->nomer_keluhan)
